...
public class Server01 implements MessageListener {

	static JMSContext jmsContext;
	
	public static void main(String[] args) throws NamingException, IOException {
		// TODO Auto-generated method stub
		Context initialContext = Server01.getContext();
		...
		JMSConsumer consumer = jmsContext.createConsumer(subscribeDestination, "pippo = 'high'");
	...
	public void onMessage(Message msg) {
		...
		try {
			...
			jmsContext.createProducer().send(replyToQueue, new CommunicationMessage(commMsg.getName(), "Server 01 echo - " + commMsg.getMessage()));
