...
public class Server02 implements MessageListener {

	static JMSContext jmsContext;
	
	public static void main(String[] args) throws NamingException, IOException {
		// TODO Auto-generated method stub
		Context initialContext = Server02.getContext();
		...
		JMSConsumer consumer = jmsContext.createConsumer(subscribeDestination,"pippo = 'low'");
	...
	public void onMessage(Message msg) {
		...
		try {
			...
			jmsContext.createProducer().send(replyToQueue, new CommunicationMessage(commMsg.getName(), "Server 02 echo - " + commMsg.getMessage()));
