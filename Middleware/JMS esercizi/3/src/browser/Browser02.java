	...
	public static void main(String[] args) throws NamingException, IOException, JMSException {
		...
		while (true) {
			try {
				...
				System.out.println("Please enter a username ( or exit) ->");
				msgSelector = bufferedReader.readLine();
				if (msgSelector.equalsIgnoreCase("exit")) {
					context.close();
					System.out.println("Goodbye");
					return;
				}
				...
				browser = context.createBrowser(queueToExamine, "username = '" + msgSelector + "'");
