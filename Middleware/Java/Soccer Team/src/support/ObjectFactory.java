...
public class ObjectFactory {
    ...
    private final static QName _GetTeam_QNAME = new QName("http://server/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://server/", "getTeams");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://server/", "getTeamsResponse");
    private final static QName _GetTeamResponse_QNAME = new QName("http://server/", "getTeamResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTeamResponse")
