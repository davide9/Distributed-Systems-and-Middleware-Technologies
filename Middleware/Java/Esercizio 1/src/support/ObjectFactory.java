...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsString_QNAME = new QName("http://server/", "getTimeAsString");
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://server/", "getTimeAsStringResponse");
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://server/", "getTimeAsElapsedResponse");
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://server/", "getTimeAsElapsed");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTimeAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTimeAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTimeAsElapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "getTimeAsElapsed")
